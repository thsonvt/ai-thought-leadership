...
fetched: '2026-01-29'
evolution_note: This article represents a significant shift towards broadening the
  application of Claude Code from coding tasks to general-purpose agent development.
topics:
...
- automation
key_quotes:
- text: The key design principle behind Claude Code is that Claude needs the same
    tools that programmers use every day.
  context: Highlighting the importance of providing Claude with tools for programming
    tasks.
- text: By giving Claude access to the user\u2019s computer (via the terminal), it\
    \ had what it needed to write code like programmers do.
  context: Emphasizing the flexibility and foundational role of the Claude Agent SDK
    in creating various types of agents.
- text: At its core, the SDK gives you the primitives to build agents for whatever
    workflow you're trying to automate.
stance:
